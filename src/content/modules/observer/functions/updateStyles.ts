...
export function updateStyles() {
    ...
    //* apply CSS
    if (document.documentElement.style.fontSize.toString() != fontSize1 || document.querySelector(`h1[role="heading"] > a[href="/home"]`)?.className.includes("r-116um31") !== fontSize2) {
        applySystemCss();
        fontSize1 = document.documentElement.style.fontSize.toString();
